...
import { dashboardPageAction } from "../../../store/dashboardSlice";
const Menubar = () => {
  ...
  const overviewHandler = () => {
    dispatch(dashboardPageAction.updateView("overview"));
  };
  const usersHandler = () => {
    dispatch(dashboardPageAction.updateView("users"));
  };
  const blogHandler = () => {
    dispatch(dashboardPageAction.updateView("blog"));
  };
  const productHandler = () => {
    dispatch(dashboardPageAction.updateView("product"));
  };
  const settingHandler = () => {
    dispatch(dashboardPageAction.updateView("setting"));
  };
  return (
    <>
      <div className={classes.menubarContainer}>
        ...
        <nav className={classes.menuList}>
          <ul>
            <li>
              <div>
                <button onClick={overviewHandler}>
                  <svg
